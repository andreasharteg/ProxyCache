...
public class HttpResponse {
    ...
    public HttpResponse(DataInputStream fromServer) {
        ...
        try {
            ...
            System.out.println("If there is an exception, then maybe this string equals null; string = " +line + "\n");
            while (line.length() != 0) {
                if (!gotStatusLine) {
                    statusLine = line;
                    gotStatusLine = true;
                 ...
                 * here. */
                if (line.startsWith("Content-Length") ||                       /* Filled in */
                        line.startsWith("Content-length")) {                   /* Filled in */
        ...
        try {
            ...
            while (bytesRead < length || loop) {
                ...
                int res = fromServer.read(buf);                                 /* Filled in */;
                if (res == -1) {
                    break;
                }
                ...
                for (int i = 0;
                    ...
                    body[bytesRead + i] = buf[i];                               /* Filled in */
                }
                bytesRead += res;
            }
            //test
